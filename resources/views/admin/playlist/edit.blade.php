...
@section('content')
  ...
  <div class="container">
        <form method="post" id="storedetails" action="<?=route('admin.playlist.update',$playlists->id);?>" enctype="multipart/form-data" class="">
          @csrf   
          <!---------tabs--------->
          ...
          <div class="col-sm-12 sevicesec active" id="step1">
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-sm-9">
                  <input type="text" name="name" value="{{$playlists->name}}" class="form-control" placeholder="Enter Playlist name">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 sevicesec"  id="step2">
            <div class="form-group">
              ...
              <div class="filename"></div>
                  @foreach($media as $vl)
                    <div id="selectedFiles" class="sel">
                      <img src="{{$vl->url}}" alt="">
                    </div>
                  @endforeach
            </div>
          ...
          <div class="col-sm-12 sevicesec"  id="step3">
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-sm-12">
                  <input type="number" class="form-control" name="slidertime" value="{{$playlists->slidertime}}">
                </div>
              </div>
            </div>
          </div>
