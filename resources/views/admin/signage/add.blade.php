...
<div class="card card-primary" style="margin:10px">
              ...
              <form method="post" action="<?=route('admin.signage.store')?>" enctype="multipart/form-data">
              @csrf  
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="area" id="exampleInputarea1" placeholder="" require>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Date of Expiry </label>
                    <input type="date" class="form-control" name="expiry" id="exampleInputEmail1" placeholder="" require>
                  </div>
